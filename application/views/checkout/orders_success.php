                    ...
                    <div class="row">
                        <div class="offset-md-3 col-md-6">
                            ...
                            <div class="text-center pb-5">
                                <a href="<?= base_url('') ?>" type="submit" class="btn btn-warning px-5 text-white mb-2" onclick="backToPreviousPage()">Back to shopping</a>
                                <!-- <a href="<?= base_url('') ?>" type="submit" class="btn btn_pay px-5 text-white" onclick="backToPreviousPage()">Take me back</a> -->
                            </div>
                        </div>
                    </div>
