            ...
            <table width="100%">
              <tr>
                <td style="text-align: left; padding: 15px">
                  <p style="font-size: 20px">Hello <?= $customername ?>,</p>
                  <p
                    style="
                      line-height: 23px;
                      font-size: 15px;
                  ...
                  <p>Thank you for your order</p>
                    <p> We have received your order <strong>"<?php echo $order_id?>"</strong> and will contact you as soon as your package is shipped. <br>
