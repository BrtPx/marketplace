            ...
            <table width="100%">
              <tr>
                <td class="two-columns">
                  ...
                  <table class="column">
                    <tr>
                      <td style="padding: 20px 62px">
                        <a href=""
                          ><img
                            src="https://patazone.co.ke/uploads/lipalater1.png"
                            alt=""
                            width="130"
                            title="Patazone Marketplace"
                        /></a>
        ...
        <tr>
          <td style="text-align: center">
            ...
            <p
              ...
              "
            >
            <?php $this->session->userdata('orderId');?>
            ...
            <table width="100%">
              <tr>
                <td style="text-align: left; padding: 15px">
                  <p style="font-size: 20px">Hello <?php $this->session->userdata('customerName') ?>,</p>
                  <p
                    style="
                      line-height: 23px;
                      font-size: 15px;
                    ...
                    "
                  >
                    Thank you for shopping on <b>patazone via lipalater</b>. We have received your order and its's 
                    being processed it will be ready for shipping once lipalater
                    verifies the purchase from their system. <br />
                    <br />
                    Afterwards our agents will get in touch with you for custom
                    software installation
                    <b>(Applicable on samartphones)</b> and shipping, you can
                    either pick it up from our hub or we ship it to your door
                    step.
                  ...
                  <!-- <a href="" class="button-dark">Reset Password</a> -->
                </td>
              </tr>
            </table>
          </td>
