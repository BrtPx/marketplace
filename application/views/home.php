...
<section id="box-2-slider">
    <div class="box-2-child show_nav_cus slicker-for 4-slides">
            ...
            <div class="tab-wrapper">
                <div class="tab-content">
                    <div class="tab-pane container active" id="Essentialall">
                        <!-- carousel_1 owl-carousel owl-theme -->
                        <div class="grid_items_section_6 slicker-for 6-slides">
                    ...
                    <?php foreach ($products['subcategoryProducts'] as $productTab) :
                        $sucategoryproducts = $this->db->limit(7)->order_by('rand()')->get_where('ptz_products', array('subcategory_id' => $productTab->id, 'is_varified' => 'yes'))->result(); ?>
...
<?php if (!empty($brands)) : ?>
    <section class="grid_section_slide_4">
        <div class="container-fluid">
            ...
            <div class="grid_items_section_5 show_nav_cus slicker-for 7-slides">
...
<?php if (!empty($products['flashsale'])) : ?>
    <section class="grid_section_5">
        <div class="container-fluid">
            ...
            <div class="tab-wrapper">
                <div class="tab-content">
                    <div class="grid_items_section_5 slicker-for 6-slides">
...
<section class="grid_section_7">
    <div class="container-fluid">
        ...
        <div class="grid_items_section_7 slicker-for 5-slides">
