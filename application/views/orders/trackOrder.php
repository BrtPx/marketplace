...
<div class="container">
    <div class="mx-xl-10">
        <div class="mb-6 text-center">
            ...
            <p class="text-gray-90 px-xl-10">To track your order please enter your Order ID in the box below and press
        ...
        <div class="my-4 my-xl-8">
            <form class="js-validate" novalidate="novalidate">
                <div class="row">
                    ...
                    <div class="col mb-1">
                        <button type="button"
                            class="btn btn-warning mb-3 mb-md-0 font-weight-normal px-5 px-md-4 px-lg-5 w-100 w-md-auto">Track</button>
                    </div>
                    <!-- End Button -->
                </div>
            </form>
